...
//                 <p className='text-xs sm:text-sm font-medium text-gray-600'>Credite left : {credit}</p>
//             </button>
      ...
      <div>
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <button
              onClick={logout}
              className='ml-2 px-4 py-2 bg-red-500 text-white rounded-full text-sm hover:bg-red-600 transition-all'
            >
              Logout
            </button>
          </div>
