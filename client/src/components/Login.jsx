...
import { assets } from "../assets/assets"; // Assuming assets like icons are in this folder

const Login = () => {
  const { setShowLogin, setToken, setUser, setCredit, backendUrl } = useContext(AppContext);
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (data.data.success) {
        ...
        setCredit(data.data.user.creditBalance);
        setShowLogin(false);
