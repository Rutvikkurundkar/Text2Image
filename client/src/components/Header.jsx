  ...
  return (
    ...
    viewport={{once: true}}>
        ...
        transition={{delay: 0.6, duration: 0.8}}>
            Unlesh your creativity eith AI. Turn Your imagination into visual art in seconds - just type, and watch the magic happen.
        </motion.p>
        ...
        className='flex flex-wrap justify-center mt-16 gap-3'>
            {Array(6).fill('').map((item, index)=>(
                ...
                className='rounded hover:105 transition-all duration-300 cursor-pointer max-sm:w-10' 
        ...
        className='mt-2 text-neutral-600'>Generate Image from Text2Vison</motion.p>
    </motion.div>
  )
}
